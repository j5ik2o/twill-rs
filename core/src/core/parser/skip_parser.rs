...
pub trait SkipParser<'a, I: 'a, A>: ClonableParser<'a, I, A> + ParserMonad<'a, I, A> + Sized
where
  Self: 'a, {
  /// Sequential parser (discard first parser result) - implemented using skip_left_with
  /// alias: p1 * p2 = p1.skip_left(p2)
  fn skip_left<P2, B>(self, p2: P2) -> impl ClonableParser<'a, I, B>
  where
    A: Clone + 'a,
    B: Clone + 'a,
    P2: ClonableParser<'a, I, B>, {
  ...
  fn skip_right<B, P2>(self, p2: P2) -> impl ClonableParser<'a, I, A>
  where
    A: Clone + 'a,
    B: Clone + 'a,
    P2: ClonableParser<'a, I, B>, {
...
impl<'a, T, I: 'a, A> SkipParser<'a, I, A> for T where T: ClonableParser<'a, I, A> + ParserMonad<'a, I, A> + 'a {}

// alias: p1 * p2 = p1.skip_left(p2)
impl<'a, I: 'a, F, G, A, B> Mul<FnParser<'a, I, B, G>> for FnParser<'a, I, A, F>
where
  ...
  B: Clone + 'a,
{
  type Output = impl ClonableParser<'a, I, B>;

  fn mul(self, rhs: FnParser<'a, I, B, G>) -> Self::Output {
    self.skip_left(rhs)
  }
}

// alias: p1 - p2 = p1.skip_right(p2)
impl<'a, I: 'a, F, G, A, B> Sub<FnParser<'a, I, B, G>> for FnParser<'a, I, A, F>
where
  F: Fn(ParseContext<'a, I>) -> ParseResult<'a, I, A> + Clone + 'a,
  G: Fn(ParseContext<'a, I>) -> ParseResult<'a, I, B> + Clone + 'a,
  A: Clone + 'a,
  B: Clone + 'a,
{
  type Output = impl ClonableParser<'a, I, A>;

  fn sub(self, rhs: FnParser<'a, I, B, G>) -> Self::Output {
    self.skip_right(rhs)
  }
}
...
mod tests {
  ...
  use crate::core::parser::SkipParser;
