...
pub trait AndThenParser<'a, I: 'a, A>: ClonableParser<'a, I, A> + ParserMonad<'a, I, A> + Sized
where
  Self: 'a, {
  /// Sequential parser (conjunction) - implemented using flat_map and map (no Clone required)
  fn and_then<P2, B>(self, p2: P2) -> impl ClonableParser<'a, I, (A, B)>
  where
    Self: 'a,
    A: Clone + 'a,
    B: Clone + 'a,
...
impl<'a, T, I: 'a, A> AndThenParser<'a, I, A> for T where T: ClonableParser<'a, I, A> + ParserMonad<'a, I, A> + 'a {}
