...
use crate::parser::{Parser, RcParser, SkipParser};
...
/// ```
pub fn surround<'a, I: Clone + 'a, A, B, C, P1, P2, P3>(lp: P1, parser: P2, rp: P3) -> RcParser<'a, I, B, impl Fn(ParseContext<'a, I>) -> ParseResult<'a, I, B> + 'a>
where
  A: Clone + 'a,
  B: Clone + 'a,
  C: Clone + 'a,
